...
# sudo ubuntu-drivers install # (install recommand v560). However, it is a beta version at the time and driver v550 is still recommended at https://www.nvidia.com/en-us/drivers/
